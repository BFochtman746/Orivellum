...
- Backend still carries dead Expo push plumbing: routes/users.py push-token endpoints, capabilities/push.py, db push_tokens table/methods, REPLIT_EXPO_DEV_DOMAIN CORS entry in api/app.py — queued for removal; don't build on it.
