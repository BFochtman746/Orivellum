...
**How to apply:** queued as tasks (sidecar+cloning; mastering+casting; whisper large-v3-turbo). Deferred, not rejected: MusicGen/Stable Audio Open for trailers (license gates needed), real-time voice chat. Draft renders = Kokoro, final = sidecar.
