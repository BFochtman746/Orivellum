    ...
    if "shot" in h and "narration" not in h:
        return {"shots": [
            ...
            for i, b in enumerate(
                ["cold open", "motif", "logline card", "turn", "title"]
            )
        ]}
    if "narration" in h or '"text"' in h:
        return {"lines": [
            {"t_start": 0, "text": "In the year the fires came…", "emotion": "somber", "pace": "slow"},
            {"t_start": 20, "text": "one promise remained.", "emotion": "reverent", "pace": "slow"},
            {"t_start": 55, "text": "(title of the work)", "emotion": "resolute", "pace": "measured"},
        ]}
