...
_LATINATE = re.compile(
    r"(?:tion|sion|ment|ance|ence|ity|ous|ive|ate|ify|ology|ism|able|ible)$"
)
...
IMAGERY_LEXICON = frozenset(
    (
        "ash", "dust", "stone", "rock", "sand", "clay", "iron", "bronze", "blood",
        "bone", "flesh", "skin", "hair", "fire", "flame", "ember", "smoke", "shadow",
        "dark", "darkness", "light", "sun", "moon", "star", "dawn", "dusk", "water",
        "river", "rain", "well", "spring", "sea", "salt", "wind", "storm", "thunder",
        "cloud", "sky", "bread", "wine", "oil", "honey", "milk", "fig", "olive", "vine",
        "wheat", "barley", "thorn", "root", "branch", "wool", "linen", "leather", "rope",
        "tent", "wall", "gate", "door", "threshold", "hearth", "lamp", "sword", "spear",
        "shield", "harp", "lyre", "drum", "horn", "dog", "sheep", "goat", "ox", "donkey",
        "camel", "lion", "serpent", "bird", "raven", "dove", "locust", "worm", "red",
        "crimson", "scarlet", "gold", "silver", "grey", "gray", "black", "white", "green",
        "blue", "purple", "cold", "heat", "warm", "bitter", "sweet", "sour", "dry",
        "wet", "rough", "smooth", "sharp", "dull", "heavy",
    )
)
