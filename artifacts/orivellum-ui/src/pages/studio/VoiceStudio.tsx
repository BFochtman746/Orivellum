...
// ── Custom line preview ───────────────────────────────────────────────────────
// "Try your own line" lives in ./CustomLinePreview so component tests can
// import it without pulling in the whole VoiceStudio tree.
              ...
              {castDocs.map(d => (
                ...
                <div className="flex items-center gap-3 p-2.5">
                  <span className="text-sm flex-1 min-w-0 truncate" title={d.title}>
                    {d.title}
                    {d.kind === "chapter" && (
                      <span className="ml-1.5 text-[10px] font-mono uppercase text-muted-foreground/70">
                        ch
                      </span>
                    )}
