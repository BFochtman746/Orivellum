...
Write-Host "    1. Install Lemonade Server (AMD's official NPU + iGPU inference stack):" -ForegroundColor Gray
Write-Host "       https://lemonade-server.ai" -ForegroundColor DarkCyan
